...
namespace WpfApp
{
    public class RecognitionViewModel: INotifyPropertyChanged
    {
        ...
        private static readonly string url = "http://localhost:58587/recognition";
        ...
        public ObservableCollection<ImagePathClassLabelProbability> ImageCollection { get; set; }
        public ObservableCollection<SingleClassLabel> SingleClassLabelCollection { get; set; }
        ...
        public bool StatisticsGettingStatus = false;
        public string ChosenDirectoryPath { get; set; }

        public RecognitionViewModel()
        {
            ImageCollection = new ObservableCollection<ImagePathClassLabelProbability>();
        ...
        public void StatisticsGetting()
        {
            StatisticsGettingStatus = true;
            ThreadPool.QueueUserWorkItem(new WaitCallback(MagicalParameter =>
            {
                try
                {
    ...
    public class ImagePathClassLabelProbability : INotifyPropertyChanged
    {
        private string path;
